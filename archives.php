...
<div class="container">
    ...
    $year = isset($_GET['year']) ? $_GET['year'] : "";
 	$sql = "SELECT * FROM `tblblogpost`  WHERE  DATE_FORMAT(  `DATEPOSTED` ,  '%Y' )  LIKE '%" .$year. "%' ORDER BY `DATEPOSTED` DESC";
		$mydb->setQuery($sql);
                ...
                <div class="mg-avl-rooms">
                    <div class="mg-avl-room">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div style="font-size: 25px;font-weight: bold;color: #000;margin-bottom: 5px;"><?php echo $result->BLOGS ;?> 
                                </div> 
                                <div class="row ">

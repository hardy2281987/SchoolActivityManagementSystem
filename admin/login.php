...
body {
   content: ' ';
  display: block;  
  background: url(../img/importance-of-time-management.jpg) no-repeat center center fixed;
      ...
      <section class="login-form">  
        <form method="post" action="" role="login">
          ...
          <!-- <img src="http://i.imgur.com/RcmcLv4.png" class="img-responsive" alt="" /> -->
           <img src="adminMenu/img/loginLogo.jpg" height="25px" class="img-responsive" alt="" />

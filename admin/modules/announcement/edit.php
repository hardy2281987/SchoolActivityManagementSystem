                    ...
                    <div class="col-md-11">
                      ...
                      <div class="col-md-4">
                          <div class='input-group date'>
                            <input type='text' id="datetimepicker2" name="ANNOUNCEMENT_WHEN" class="form-control TRANSDATE" value="<?php echo $res->ANNOUNCEMENT_WHEN;?>" placeholder="mm/dd/yyyy hh:mm"/>
                    ...
                    <div class="col-md-11">
                      ...
                      <div class="col-md-10">
                           <input class="form-control input-sm" id="ANNOUNCEMENT_WHERE" name="ANNOUNCEMENT_WHERE" placeholder=
                            "Where" type="text" value="<?php echo $res->ANNOUNCEMENT_WHERE ; ?>">
                      </div>
                    </div>
                  </div>

...
/*#example{
 ...
 <div class="row">
      <div class="col-lg-12"> 
            <h1 class="page-header">List of Announcements <small>|  <label class="label label-xs" style="font-size: 12px"><a href="index.php?view=add">  <i class="fa fa-plus-circle fw-fa"></i> New</a></label> |</small></h1> 
